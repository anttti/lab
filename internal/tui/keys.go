...
type KeyMap struct {
	Up, Down, Select, Back, Top, Bottom, Filter, CycleFilter, CycleFilterBack, ToggleUnread, Sync, Claude, Next, Prev, Quit key.Binding
}
...
var Keys = KeyMap{
	...
	CycleFilter:     key.NewBinding(key.WithKeys("tab"), key.WithHelp("tab", "cycle project")),
	CycleFilterBack: key.NewBinding(key.WithKeys("shift+tab"), key.WithHelp("shift+tab", "cycle project back")),
